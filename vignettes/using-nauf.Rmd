...
If you use the *nauf* package in a publication, please cite:
    ...
    Eager, Christopher D. (2017). nauf: Regression with Not Applicable Values in Unordered Factors. R package version 1.0.0. https://CRAN.R-project.org/package=nauf
