...
test_that("factor method works", {
  expect_equal(named_contr_sum(uf, FALSE), uf_ncs)
  expect_equal(named_contr_sum(of, FALSE), of_ncs)
  expect_equal(named_contr_sum(lf, FALSE), lf_ncs)
  expect_equal(named_contr_sum(nlf, FALSE), nlf_ncs)
  expect_equal(named_contr_sum(nf, FALSE), nf_ncs)
  expect_equal(named_contr_sum(cf, FALSE), cf_ncs)
})
